...
description: Learn how to add a scroll progress bar, scroll to top button, and reading time indicator to you Next.js blog. All three of those features are very easy to implement and can be doen in a couple of hours.
